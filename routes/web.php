...
$router->group(['prefix' => 'v1'], function () use ($router) {
    ...
    $router->get('users/{id}/journal_question_favourites',  ['uses' => 'UserController@getUserJournalQuestionFavourites']);
    ...
    //favourites
    $router->get('favourites',  ['uses' => 'FavouritesController@getAllFavourites']);
    $router->get('favourites/{id}', ['uses' => 'FavouritesController@getOneFavourite']);
    $router->post('favourites', ['uses' => 'FavouritesController@create']);
    $router->delete('favourites/{id}', ['uses' => 'FavouritesController@delete']);
    $router->put('favourites/{id}', ['uses' => 'FavouritesController@update']);
});
